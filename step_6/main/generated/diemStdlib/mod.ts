...
constructor (public coin_type: DiemTypes.TypeTag, public to: DiemTypes.AccountAddress, public amount: uint64) {
  super();
}
...
export class Stdlib {
   ...
   */
  static encodeTransferScriptFunction(coin_type: DiemTypes.TypeTag, to: DiemTypes.AccountAddress, amount: bigint): DiemTypes.TransactionPayload {
